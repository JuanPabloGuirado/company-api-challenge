package com.ITPatagonia.javabackendchallenge.infrastructure.aspect;
...
import com.ITPatagonia.javabackendchallenge.utils.enums.Constants;
...
public class ValidationAspect {
    ...
    @Before("@annotation(com.ITPatagonia.javabackendchallenge.domain.validation.ValidateInputParams) && args(request, ..)")
